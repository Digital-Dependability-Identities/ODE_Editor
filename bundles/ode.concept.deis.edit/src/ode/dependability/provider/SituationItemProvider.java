...
/**
 * This is the item provider adapter for a {@link ode.dependability.Situation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SituationItemProvider extends RiskParameterItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Situation_likelihood_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Situation_likelihood_feature", "_UI_Situation_type"),
				 Dependability_Package.Literals.SITUATION__LIKELIHOOD,
				 true,
				 false,
				 false,
