...
import ode.argumentation.Assertion;
...
/**
 * This is the item provider adapter for a {@link ode.argumentation.Assertion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArgumentationPackage.Literals.ASSERTION__ASSERTION_DECLARATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArgumentationPackage.Literals.ASSERTION__META_CLAIM,
				 true,
				 false,
				 true,
				 null,
