...
/**
 * This is the item provider adapter for a {@link ode.dependability.DomainPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainPackageItemProvider extends ODEProductPackageItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Dependability_Package.Literals.DOMAIN_PACKAGE__STANDARDS);
			childrenFeatures.add(Dependability_Package.Literals.DOMAIN_PACKAGE__ASSURANCE_LEVELS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Dependability_Package.Literals.DOMAIN_PACKAGE__STANDARDS,
				 Dependability_Factory.eINSTANCE.createStandard()));

		newChildDescriptors.add
			(createChildParameter
				(Dependability_Package.Literals.DOMAIN_PACKAGE__STANDARDS,
				 Dependability_Factory.eINSTANCE.createSafetyStandard()));

		newChildDescriptors.add
			(createChildParameter
				(Dependability_Package.Literals.DOMAIN_PACKAGE__ASSURANCE_LEVELS,
				 Dependability_Factory.eINSTANCE.createAssuranceLevel()));
	}
