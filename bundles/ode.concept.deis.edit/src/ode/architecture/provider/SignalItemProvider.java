...
import ode.architecture.Signal;
...
/**
 * This is the item provider adapter for a {@link ode.architecture.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalItemProvider extends BaseElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_fromPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_fromPort_feature", "_UI_Signal_type"),
				 ArchitecturePackage.Literals.SIGNAL__FROM_PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addToPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_toPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_toPort_feature", "_UI_Signal_type"),
				 ArchitecturePackage.Literals.SIGNAL__TO_PORT,
				 true,
				 false,
				 true,
				 null,
