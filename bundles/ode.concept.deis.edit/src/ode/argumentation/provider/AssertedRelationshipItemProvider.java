...
import ode.argumentation.AssertedRelationship;
...
/**
 * This is the item provider adapter for a {@link ode.argumentation.AssertedRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssertedRelationshipItemProvider extends AssertionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArgumentationPackage.Literals.ASSERTED_RELATIONSHIP__IS_COUNTER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArgumentationPackage.Literals.ASSERTED_RELATIONSHIP__REASONING,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArgumentationPackage.Literals.ASSERTED_RELATIONSHIP__REQUIES,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AssertedRelationship.class)) {
			case ArgumentationPackage.ASSERTED_RELATIONSHIP__IS_COUNTER:
			case ArgumentationPackage.ASSERTED_RELATIONSHIP__REQUIES:
