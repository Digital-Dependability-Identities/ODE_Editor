...
/**
 * This is the item provider adapter for a {@link ode.architecture.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider extends BaseElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_subSystems_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_subSystems_feature", "_UI_Configuration_type"),
				 ArchitecturePackage.Literals.CONFIGURATION__SUB_SYSTEMS,
				 true,
				 false,
				 true,
				 null,
