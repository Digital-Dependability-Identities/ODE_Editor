...
/**
 * This is the item provider adapter for a {@link ode.dependability.Human} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HumanItemProvider extends ThreatAgentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Human_actions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Human_actions_feature", "_UI_Human_type"),
				 Dependability_Package.Literals.HUMAN__ACTIONS,
				 true,
				 false,
				 true,
				 null,
