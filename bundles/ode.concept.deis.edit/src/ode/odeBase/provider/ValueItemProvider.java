...
/**
 * This is the item provider adapter for a {@link ode.odeBase.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_tag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_tag_feature", "_UI_Value_type"),
				 OdeBasePackage.Literals.VALUE__TAG,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OdeBasePackage.Literals.VALUE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Value)object).getTag();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Value.class)) {
			case OdeBasePackage.VALUE__TAG:
			case OdeBasePackage.VALUE__VALUE:
